package com.example.bai13truonghop2nguyentrinhkhanhtoan;
...
public class TruongHop2_NguyenTrinhKhanhToan extends Activity {

	protected void onCreate(Bundle savedInstanceState) {
		 super.onCreate(savedInstanceState);
		 setContentView(R.layout.truong_hop2_nguyentrinhkhanhtoan);
